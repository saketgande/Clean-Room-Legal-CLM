...
class TrademarksService:
    def __init__(self, db: Session, *, storage: StorageBackend | None = None, reducto=None, claude_client=None):
        self.db = db
    ...
    def list_upcoming_renewals(self, *, org_id: str, within_days: int = 90) -> list[Trademark]:
