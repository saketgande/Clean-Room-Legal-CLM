from app.ai.schemas import (
    ...
    PrivacyIncidentAssessmentOutput,
...
for registered_spec in [
    ...
    SkillSpec(
        ...
        version="1.0.0",
        description="Assess a data-privacy incident's severity and notification obligations for the flow engine's privacy-assessment-agent step.",
        execution_mode="flow_task",
        prompt_key="privacy_incident_assessment",
        prompt_version="1.0.0",
        input_model=None,
        output_model=PrivacyIncidentAssessmentOutput,
        required_permission="intake:read",
        resource_type=None,
        requires_citations=False,
        allows_mutation=False,
        feature_flag="feature.ai.privacy_incident_assessment",
        enabled_by_default=True,
        max_tokens=1536,
    ),
]:
