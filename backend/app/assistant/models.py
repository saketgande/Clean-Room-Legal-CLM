...
class AssistantContractHandle(
    ...
    __table_args__ = (
        UniqueConstraint("session_id", "handle", name="uq_assistant_contract_handle_session_handle"),
        UniqueConstraint("session_id", "contract_id", name="uq_assistant_contract_handle_session_contract"),
    )
