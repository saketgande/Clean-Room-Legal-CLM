...
def _breaker_for(provider: str) -> Any:
    ...
    if breaker is None and _PYBREAKER_AVAILABLE:
...
def with_circuit_breaker(
    ...
    No-op when pybreaker is unavailable. When the circuit is OPEN, raises
    :class:`ProviderUnavailableError` (HTTP 503 + Retry-After) instead of
    attempting the doomed call.
    """
