    ...
    <div className="ctl">
      ...
      <div className="top">
        ...
        <div className="toolbar">
          ...
          <FilterMenu
            ...
            options={[
              { v: "critical", label: "Critical", dot: "var(--crit)" },
              { v: "high", label: "High", dot: "var(--crit)" },
      ...
      <div className={cn("brief", briefCollapsed && "collapsed")}>
        ...
        <div className="oneline">
          ...
          <b style={{ color: "var(--crit)" }}>{highRows.length} high-risk</b>
        </div>
...
const CTL_CSS = `
.ctl{--cyan:#1c7f96;--cyan-soft:#e2f3f6;--shadow:0 1px 2px rgba(20,26,40,.05),0 8px 22px rgba(20,26,40,.06);--pop:0 12px 30px rgba(20,26,40,.16);--sans:var(--font-sans);--mono:ui-monospace,SFMono-Regular,Menlo,monospace;height:100%;display:flex;flex-direction:column;min-height:0;color:var(--ink);font:400 13px/1.5 var(--sans)}
.dark .ctl{--cyan:#5fc2d8;--cyan-soft:#132a2e;--shadow:0 1px 2px rgba(0,0,0,.4),0 10px 26px rgba(0,0,0,.4);--pop:0 14px 34px rgba(0,0,0,.55)}
...
.ctl .stat .warn{color:var(--warn)} .ctl .stat .crit{color:var(--crit)}
.ctl .btn{padding:6px 11px;border-radius:8px;font-size:12px}
...
.ctl .summary b{font-weight:680} .ctl .summary .c{color:var(--crit);font-weight:680} .ctl .summary .w{color:var(--warn);font-weight:680}
...
.ctl .tile.a .tn{color:var(--accent)} .ctl .tile.g .tn{color:var(--good)} .ctl .tile.w .tn{color:var(--warn)} .ctl .tile.c .tn{color:var(--crit)}
...
.ctl .attchip.c{border-color:color-mix(in srgb,var(--crit) 40%,var(--border));color:var(--crit);background:var(--crit-soft)}
...
.ctl .tag.red{background:var(--crit-soft);color:var(--crit)}
...
.ctl .exp .soon{color:var(--warn);font-weight:650} .ctl .exp .past{color:var(--crit);font-weight:650}
