...
.li-board{
  ...
  --ext:#75589f;--ext-soft:#efe8f7;--ai:#3f6699;--ai-soft:#e7eef8;
...
.dark .li-board{
  ...
  --ext:#ab90d2;--ext-soft:#221b31;--ai:#6f9bd6;--ai-soft:#151f2e;
...
.li-board .btn{padding:6px 11px;border-radius:8px;font-size:12px}
